...
\author{\textbf{Fengwei Zhang and Shiqing Liu} \\\vspace{3pt}}
\institute{COMPASS Lab, SUSTech\\ \vspace{5pt}
\includegraphics[width=1.5cm]{SUSTech-Beamer-Theme/pic/sustech-logo.jpeg}
\includegraphics[width=1.4cm]{SUSTech-Beamer-Theme/pic/compass-logo}}
...
\begin{frame}{The Security Mechanism}
    % TrustZone is a seperate and protected region in CPU.
